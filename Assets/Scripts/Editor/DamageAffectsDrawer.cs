...
//[CustomPropertyDrawer(typeof(DamageAffect))]
public class DamageAffectsDrawer : PropertyDrawer
{
    ...
    //         buttonPressed[i] = GUI.Toggle(buttonPos, buttonPressed[i], _property.enumNames[i], style);
